...
<div class="row">
            <div class="col-md-4 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title text-md-center text-xl-left">Capital</p>
                  <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
                    <h3 class="mb-0 mb-md-2 mb-xl-0 order-md-1 order-xl-0">{{$userBlanace.' BTC' ?? 'NA'}}</h3>
            ...
            <div class="col-md-4 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
                    <h3 class="mb-0 mb-md-2 mb-xl-0 order-md-1 order-xl-0">{{$profitPer ?? ''}}%</h3>
            ...
            <!--  <div class="card">-->
            <!--    <div class="card-body">-->
            <!--      <p class="card-title text-md-center text-xl-left">Markets</p>-->
            <!--      <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">-->
            ...
            <div class="col-md-4 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title text-md-center text-xl-left">Total Assets</p>
                  <div class="d-flex flex-wrap justify-content-between justify-content-md-center justify-content-xl-between align-items-center">
                    <h3 class="mb-0 mb-md-2 mb-xl-0 order-md-1 order-xl-0">{{$total ?? '0.0'}} BTC</h3>
          ...
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card position-relative">
                <div class="card-body">
                  <p class="card-title">Your Affiliate Link</p>
                  <div class="row">
                   
                    <div class="col-md-12 col-xl-12">
                      <div class="row">
                      <input type="text" id="affiliate-link" name="affiliate-link" value="{{$affiliateUrl}}" onClick="this.select();">
                      </div>
                    </div>    
                  </div>
                </div>
              ...
              <div class="card border-bottom-0">
                <div class="card-body pb-0">
                  ...
                  <div class="d-flex flex-wrap mb-5">
                    <div class="me-5 mt-3">
                      <p class="text-muted">Renewal</p>
                      <h3>{{$renewalCount}}</h3>
                    </div>
                    <div class="me-5 mt-3">
                      <p class="text-muted" >Affiliate</p>
                      <h3>{{$affiliateCount}}</h3>
                    </div>
                    <!-- <div class="me-5 mt-3">
          ...
          <!-- <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card position-relative">
                <div class="card-body">
                  <p class="card-title">Market Diversification</p>
                  <div class="row">
